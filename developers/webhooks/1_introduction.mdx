...
<Steps>
  ...
  <Step title="Probá la integración">
    Verificá que tu endpoint reciba los eventos correctamente. Los logs de entrega se consultan por [API](/api-reference/webhook/obtener-lista-de-registros-de-webhook).
  </Step>
</Steps>
