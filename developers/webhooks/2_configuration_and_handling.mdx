...
Cada webhook genera un log automático en Fint que registra todos los intentos de entrega. Hoy se consulta por API, no desde Configuración → Desarrolladores.
