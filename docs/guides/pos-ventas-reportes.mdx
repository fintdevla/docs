...
Al hacer clic en una venta se abre el panel **Orden de pago**: cliente, ítems, pagos y detalle. Un intento **rechazado** abre **Intento de cobro** con el motivo y las referencias del proveedor.
