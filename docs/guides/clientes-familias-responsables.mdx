...
En el módulo **Estudiantes** hay una pestaña **Contactos**. Es el listado de todos los responsables: nombre, documento y a quiénes pagan. No reemplaza el alta desde el perfil; sirve para encontrar a un responsable sin abrir cada estudiante.
