...
<img src="/docs/images/solicitudes-pago/ordenes-listado.png" alt="Listado de órdenes con estados Por Cobrar, Pagada y Pago Parcial" />
...
<img src="/docs/images/solicitudes-pago/orden-detalle.png" alt="Detalle de una orden vencida con el interés por mora acumulado" />
...
<Steps>
  <Step title="Elegí el tipo de factura">
    **Venta online** (items de pago único) o **Liquidación** (items de liquidación del período).

    <img src="/docs/images/solicitudes-pago/crear-orden-tipo.png" alt="Selección del tipo de factura: venta online o liquidación" />
  </Step>
  ...
  <Step title="Completá los datos">
    ...
    <img src="/docs/images/solicitudes-pago/crear-orden.png" alt="Formulario de creación de una orden con vista previa" />
  </Step>
...
<img src="/docs/images/solicitudes-pago/liquidacion-detalle.png" alt="Liquidación en borrador: una orden por estudiante con los descuentos ya aplicados" />
...
<img src="/docs/images/solicitudes-pago/liquidaciones-listado.png" alt="Listado de liquidaciones: una enviada y una pendiente en borrador" />
