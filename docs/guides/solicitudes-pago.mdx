...
Una **orden** registra un importe que un cliente debe pagar. Puede nacer de una carga manual, una liquidación, un Link de Pago, una suscripción, un evento, el POS, la API o, a veces, conciliación (**Crear factura**).

Una orden **no se vence sola**. **Vencida** es un filtro de Por Cobrar. Las de liquidación en borrador están **No Enviadas** y no las ve la familia.
...
<CardGroup cols={2}>
  <Card title="Gestionar Órdenes" icon="magnifying-glass" href="/docs/guides/ordenes-gestionar">
...
<Frame>
  <img src="/docs/images/solicitudes-pago/ordenes-listado.png" alt="Listado de órdenes de Colegio Modelo, con cuotas por cobrar y ventas de tienda escolar pagadas" />
</Frame>
