...
Historial completo de pagos realizados con el detalle de cada factura. Si tu institución [factura con ARCA](/docs/guides/facturacion), el comprobante en PDF queda disponible para descargar desde el detalle de la factura.

<img src="/docs/images/portal-contacto/historial.png" alt="Historial de facturas pagadas en el portal" />

### Actualizar datos

El responsable puede modificar su email, su número de WhatsApp y su documento desde el perfil del portal.
...
1. El contacto recibe un email de confirmación del pago
