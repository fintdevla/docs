...
Usá el **buscador** para encontrar pagos por nombre del cliente, número de referencia, concepto o descripción. También podés filtrar por **medio de pago** (tarjeta, transferencia, efectivo), **origen** (Manual u Online), **registrado por** (qué admin lo registró) y **etiquetas** del cliente.
...
La exportación abarca todos los pagos del rango de fechas elegido — los filtros del listado no se aplican al archivo exportado.
