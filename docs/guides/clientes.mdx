...
Según la configuración de tu organización, también pueden aparecer campos personalizados. Si Teachable está conectado, el perfil muestra **Cursos de Teachable** para inscribir, desinscribir o reinscribir. El detalle está en [Teachable](/docs/guides/teachable).
