...
Hay dos vínculos distintos: (1) **este navegador** elige la caja (queda en el dispositivo; la primera vez, si hay varias). (2) La caja de Mercado Pago tiene (o no) un Point en modo PDV y/o un QR. Elegir caja en una PC no cambia otra. En el modal, **Sin dispositivo** no implica que falte el QR.
