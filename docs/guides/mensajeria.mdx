...
<img src="/docs/images/mensajeria/crear-tipo.png" alt="Selección del tipo de destinatario del comunicado" />
...
<Steps>
  ...
  <Step title="Configurá el contenido">
    ...
    <img src="/docs/images/mensajeria/crear.png" alt="Compositor del comunicado con vista previa del email" />
  </Step>
