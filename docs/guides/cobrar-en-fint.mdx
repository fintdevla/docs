...
<CardGroup cols={2}>
  ...
  <Card title="Registrá un cobro recibido" icon="pen" href="/docs/guides/pagos#registrar-un-pago-manual">
    Si el dinero llegó en efectivo, transferencia u otro medio fuera de Fint, cargalo sobre la orden. Para deshacerlo, [eliminá el pago manual](/docs/guides/pagos#cancelar-o-eliminar-un-pago).
  </Card>
