...
<Info>
  El Portal no permite saltear las facturas más antiguas. Si necesitás cobrar abril con marzo impaga, registrá un [pago manual](/docs/guides/pagos#registrar-un-pago-manual) sobre esa orden o [conciliá](/docs/guides/conciliacion) eligiendo esas órdenes.
</Info>
