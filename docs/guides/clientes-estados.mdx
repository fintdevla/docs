...
<img src="/docs/images/clientes/confirmar-baja.png" alt="Confirmación Dar de baja el estudiante: no se generan órdenes nuevas, las existentes quedan, no se envían más recordatorios" />
...
**Con deuda** y **Pago pendiente** miran órdenes institucionales vencidas o a vencer. Una entrada de evento, un borrador, una bonificación o una orden cancelada **no** cambian ese semáforo.
