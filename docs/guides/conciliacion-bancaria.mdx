...
Después de asignar responsable, Fint arma **sugerencias**: combinaciones de cuotas del mismo mes (con o sin mora de esa fecha), las más viejas primero. No es magia de “una orden del mismo importe”. Ves hasta 3 lecturas. **Recalcular sugerencias** está en Acciones del movimiento.
...
Consultá [Preguntas frecuentes](/docs/guides/conciliacion-bancaria-casos-frecuentes) si el ingreso no cierra como en este recorrido.
...
Para identificar movimientos al importar, consultá [Reglas de identificación](/docs/guides/conciliacion-bancaria-reglas).
