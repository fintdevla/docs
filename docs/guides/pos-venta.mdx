...
Hacé clic sobre un producto para sumarlo. Los productos con stock **0** aparecen **Sin stock** y no se agregan. El **+** no corta en el cupo: si cargás de más, el bloqueo llega al **Continuar al pago** (`Sin stock para "…"`). Un item en **Borrador** igual se puede asociar y cobrar. No hay combos en el POS: cada producto es un renglón. Los descuentos van abajo, en rojo, sin cantidad.

Podés buscar por nombre, filtrar por grupo y ordenar por:
