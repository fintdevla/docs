...
Hacé clic sobre un producto para sumarlo. Los productos con stock **0** aparecen **Sin stock** y no se agregan. Cada producto es un renglón. Los descuentos van abajo, en rojo.
