...
El acceso **Configurar plazos y comisión** abre el panel de Mercado Pago del país de la organización (Argentina o Uruguay), donde definís los plazos de acreditación y consultás sus comisiones.
...
Hay **un procesador de cobro por organización**. Con Mercado Pago activo, Stripe, Pagos360 y el resto muestran **Contactarse para activar**, no un segundo **Conectar**. Para cambiar de procesador: **Desconectar** y después conectar el otro.
