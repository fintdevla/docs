...
Al crear o editar un evento, tenés cuatro secciones de opciones avanzadas:
...
Para crear entradas manuales (cortesías, staff, invitados), usá el botón **"+ Crear entrada"**.
