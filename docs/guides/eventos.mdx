...
El módulo tiene tres áreas. Cada una corresponde a un momento del trabajo:

<CardGroup cols={3}>
  <Card title="Eventos" icon="calendar-days">
    Buscá eventos, abrí su detalle y separá la lista principal de los archivados.
  </Card>
  <Card title="Asistentes" icon="users">
    Consultá cada entrada emitida, su comprador, su asistente y su estado de admisión.
  </Card>
  <Card title="Estadísticas" icon="chart-column">
    Seguí ventas, entradas vigentes, admisiones y el detalle por producto o tipo de entrada.
  </Card>
</CardGroup>
