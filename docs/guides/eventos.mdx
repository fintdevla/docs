...
- Un **tipo de entrada** define nombre, precio, **stock** y si genera QR. Con stock 0 no se vende.
- Un **combo** vende varias entradas juntas. No tiene stock propio: usa el de cada tipo. Los descuentos del evento **no aplican a combos**.
- Un **cupón de evento** también tiene stock: sin unidades, el código no se aplica.
