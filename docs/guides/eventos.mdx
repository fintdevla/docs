...
<img src="/docs/images/eventos/listado.png" alt="Listado de eventos en línea de tiempo" />
...
<img src="/docs/images/eventos/detalle.png" alt="Detalle del evento con estadísticas de ventas, entradas y admisión" />
...
<Steps>
  <Step title="Completá los datos del evento">
    ...
    **Imagen del evento**: Subí una imagen representativa que se mostrará en la página pública y en la sección Descubre. Podés usar formatos **cuadrados** (1:1, ej: 1080x1080px) o **rectangulares** (16:9, ej: 1920x1080px). Recomendamos imágenes de alta calidad (mínimo 1000px de ancho) para mejor visualización.
    ...
    <img src="/docs/images/eventos/editar.png" alt="Editor del evento: datos generales, entradas, descuentos y opciones" />
  </Step>
  ...
  <Step title="Agregá las entradas">
    ...
    <img src="/docs/images/eventos/entradas-config.png" alt="Entradas del evento con stock y precio, y sección de combos" />
  </Step>
  ...
  <Step title="Publicá o guardá como borrador">
    ...
    <img src="/docs/images/eventos/pagina-publica.png" alt="Página pública del evento con las entradas a la venta" />
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Configuración general">
    <img src="/docs/images/eventos/configuracion-evento.png" alt="Configuración del evento: URL, costo del servicio, expiración del carrito" />
  ...
  <Accordion title="Pedido de información">
    ...
    **De los asistentes**, los campos base (nombre, documento, email, teléfono) se configuran en cada entrada desde [Items y Descuentos](/docs/guides/items-descuentos#campos-segun-el-tipo).
    ...
    <img src="/docs/images/eventos/pedido-informacion.png" alt="Pedido de información: campos del comprador y de los asistentes" />
    ...
    <img src="/docs/images/eventos/campo-personalizado.png" alt="Modal para agregar un campo personalizado al evento" />
  </Accordion>
...
<img src="/docs/images/eventos/entradas.png" alt="Pestaña Asistentes con las entradas vendidas y su estado de admisión" />
...
Con [ARCA conectado](/docs/guides/facturacion-arca) y [reglas de facturación](/docs/guides/facturacion) configuradas, los pagos de las entradas se facturan automáticamente. Cada comprobante queda asociado a su pago en el módulo de [Pagos](/docs/guides/pagos).
