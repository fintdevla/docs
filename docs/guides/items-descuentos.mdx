...
<CardGroup cols={2}>
  ...
  <Card title="Venta online" icon="cart-shopping" href="/docs/guides/items-venta-online-stock">
    Usalo para productos o servicios de Links de Pago y para el catálogo del Punto de Venta. Si Teachable está conectado, este tipo admite asociar un [curso](/docs/guides/teachable).
  </Card>
...
Usá **Importar Excel** para altas masivas y descargá siempre el modelo actual desde el modal. El importador acepta archivos `.xlsx`.

La plantilla crea la configuración básica. No incluye imágenes, asignaciones a clientes, mora, condiciones de descuento ni códigos de cupón; completá esos datos después desde cada registro.

<Warning>
  Revisá el canal, el estado, la vigencia y el stock de los registros importados antes de asociarlos a una liquidación o canal de venta.
</Warning>
