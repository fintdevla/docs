...
<Warning>
  Hoy **no hay reembolso desde el Punto de Venta**. Una venta cobrada no se anula acá. Si hace falta devolver, es en el panel del procesador (y en [Facturación](/docs/guides/facturacion) si ya salió comprobante).
</Warning>

El POS **no imprime factura**. El ticket del Point no es el PDF de ARCA. El comprobante, si corresponde, nace del **pago** con una [regla](/docs/guides/facturacion) que incluya Efectivo, Transferencia o Mercado Pago.
