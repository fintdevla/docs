...
<Steps>
  <Step title="Abrí Puntos de venta">
    Entrá a **Punto de Venta → Puntos de venta**. El menú de la tarjeta muestra **Duplicar**, **Exportar ventas** y **Eliminar**. Eliminar saca el punto de venta del listado; las ventas ya hechas quedan en Órdenes y Pagos.
  </Step>
  <Step title="Crealo">
