...
<img src="/docs/images/links-pago/crear.png" alt="Formulario Crear link de pago con el taller Curso de Robótica y la vista previa de la página pública" />
...
<Steps>
  ...
  <Step title="Artículos y etiquetas">
    ...
    <img src="/docs/images/links-pago/crear-articulos.png" alt="Selector de artículos de Venta online para sumar al link" />
  </Step>
...
<img src="/docs/images/links-pago/listado.png" alt="Listado de links de pago con Taller de Ajedrez y Curso de Robótica en estado Activa" />
...
El primer slice de esta guía no recorre el checkout hasta el final. Eso queda para cuando el cobro se pueda probar en local sin dejar residuos.
