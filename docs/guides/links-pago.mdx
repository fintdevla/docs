...
<Steps>
  ...
  <Step title="Cobro, si tu procesador lo permite">
    La sección **Cobro** aparece cuando la organización usa **Stripe** o **Mercado Pago**. El interruptor **Debitar automáticamente todos los meses** intenta el débito solo.
...
Si el link está vencido, la página pública dice **Link de pago expirado**. No se puede comprar. La fecha corta a las **23:59** de ese día. Si no hay fecha, no vence.

No hay tope de usos ni de compras. Cada compra crea o reconoce al cliente, genera una orden y, si el cobro se confirma, un pago. El **stock del item no se reserva** en este canal. Pasar el link a **Borrador** deja de publicarlo.
